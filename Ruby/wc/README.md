...
> ruby ccwc.rb -m <filename_with_extension> <br>
> or <br>
> cat <filename_with_extension> | ruby ccwb -m
* example: <br>
  - `ruby ccwc.rb -m test.txt` <br>
  `339292 test.txt`
  - `cat test.txt | ruby ccwc.rb -m` <br>
  `339292`
